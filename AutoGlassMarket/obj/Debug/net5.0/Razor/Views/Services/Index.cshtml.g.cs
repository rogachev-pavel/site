#pragma checksum "C:\Users\Павел\source\repos\AutoGlassMarket\AutoGlassMarket\Views\Services\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "292df8097ca7ba59e06b29009af1cdecadd1799c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"292df8097ca7ba59e06b29009af1cdecadd1799c", @"/Views/Services/Index.cshtml")]
    ...
    <div class=""p-2 mb-4 bg-light rounded-3 shadow-lg p-3 mb-5"">
        <div class=""container-fluid"">
            ...
            <hr class=""featurette-divider"">
            <button class=""btn btn-primary btn-lg"" type=""button""><font style=""vertical-align: inherit;""><font style=""vertical-align: inherit;"">Заказать услугу</font></font></button>
        </div>
    </div>
        ...
        <div class=""col-md-6"">
            <div class=""h-100 p-5 text-white bg-dark rounded-3 shadow-lg p-3 mb-5"">
                ...
                <p>
                    <font style=""vertical-align: inherit;"">
                        <font style=""vertical-align: inherit;"">
                            Процедура замены:<br>Снятие дворников, молдингов и резинок, демонтаж отдельных элементов обшивки, чтобы избежать повреждений и загрязнений кле");
            WriteLiteral(@"ем.<br>Удаление осколков разбитого стекла, если стекло цело, то демонтаж путем среза .
                ...
                <h1 class=""display-8 ""><font style=""vertical-align: inherit;""><font style=""vertical-align: inherit;"">от 1500руб</font></font></h1>
                <hr class=""featurette-divider"">
                <button class=""btn btn-outline-light"" type=""button""><font style=""vertical-align: inherit;""><font style=""vertical-align: inherit;"">Заказать услугу</font></font></button>
            </div>
        </div>
        <div class=""col-md-6"">
            <div class=""h-100 p-5 bg-light border rounded-3 shadow-lg p-3 mb-5"">
                <h2><font style=""vertical");
            WriteLiteral(@"-align: inherit;""><font style=""vertical-align: inherit;"">Замена боковых стекол</font></font></h2>
                ...
                <hr class=""featurette-divider"">
                <button class=""btn btn-outline-secondary"" type=""button""><font style=""vertical-align: inherit;""><font style=""vertical-align: inherit;"">Пример кнопки</font></font></button>
            </div>
        </div>
    </div>
